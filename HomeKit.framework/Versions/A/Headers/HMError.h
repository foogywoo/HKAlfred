...
HM_EXTERN NSString * const HMErrorDomain API_AVAILABLE(macos(10.10), ios(8.0))  ;
...
typedef NS_ENUM(NSInteger, HMErrorCode) {
    HMErrorCodeUnexpectedError                         API_AVAILABLE(macos(10.10), ios(11.2), watchos(4.2), tvos(11.2)) = -1,
    ...
    HMErrorCodeCannotRemoveBuiltinActionSet            API_AVAILABLE(macos(10.10), ios(9.0)) = 83,
    HMErrorCodeLocationForHomeDisabled                 API_AVAILABLE(macos(10.10), ios(9.0)) = 84,
    HMErrorCodeNotAuthorizedForLocationServices        API_AVAILABLE(macos(10.10), ios(9.0)) = 85,
    HMErrorCodeReferToUserManual                       API_AVAILABLE(macos(10.10), ios(9.3)) = 86,
    HMErrorCodeInvalidOrMissingAuthorizationData       API_AVAILABLE(macos(10.10), ios(10.0)) = 87,
    HMErrorCodeBridgedAccessoryNotReachable            API_AVAILABLE(macos(10.10), ios(10.0)) = 88,
    HMErrorCodeNotAuthorizedForMicrophoneAccess        API_AVAILABLE(macos(10.10), ios(10.0)) = 89,
    HMErrorCodeIncompatibleNetwork                     API_AVAILABLE(macos(10.10), ios(10.2)) = 90,
    HMErrorCodeNoHomeHub                               API_AVAILABLE(macos(10.10), ios(11.0)) = 91,
    HMErrorCodeNoCompatibleHomeHub                     API_AVAILABLE(macos(10.10), ios(11.0)) = 92,
    HMErrorCodeIncompatibleAccessory                   API_AVAILABLE(macos(10.10), ios(11.3)) = 93,
    ...
    HMErrorCodeObjectWithSimilarNameExists             API_AVAILABLE(macos(10.10), ios(12.0)) = 95,
