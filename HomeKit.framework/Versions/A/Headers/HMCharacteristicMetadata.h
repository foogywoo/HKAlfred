 ...
 */
@property(readonly, copy, nonatomic, nullable) NSArray<NSNumber *> *validValues API_AVAILABLE(macos(10.10), ios(10.0), watchos(3.0), tvos(10.0));
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatBool API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatInt API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatFloat API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatString API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatArray API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatDictionary API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatUInt8 API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatUInt16 API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatUInt32 API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatUInt64 API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatData API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataFormatTLV8 API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
 ...
 */
HM_EXTERN NSString * const HMCharacteristicMetadataUnitsCelsius API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;

/*!
 * @brief Describes that the unit of the characteristic is in Fahrenheit.
 */
HM_EXTERN NSString * const HMCharacteristicMetadataUnitsFahrenheit API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;

/*!
 * @brief Describes that the unit of the characteristic is a percentage.
 */
HM_EXTERN NSString * const HMCharacteristicMetadataUnitsPercentage API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;

/*!
 * @brief Describes that the unit of the characteristic is arc degree.
 */
HM_EXTERN NSString * const HMCharacteristicMetadataUnitsArcDegree API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;

/*!
 * @brief Describes that the unit of the characteristic is seconds.
 */
HM_EXTERN NSString * const HMCharacteristicMetadataUnitsSeconds API_AVAILABLE(macos(10.10), ios(8.3), watchos(2.0), tvos(10.0))  ;

/*!
 * @brief Describes that the unit of the characteristic is Lux (illuminance).
 */
HM_EXTERN NSString * const HMCharacteristicMetadataUnitsLux API_AVAILABLE(macos(10.10), ios(9.3), watchos(2.2), tvos(10.0))  ;

/*!
 * @brief Describes that the unit of the characteristic is parts per million.
 */
HM_EXTERN NSString * const HMCharacteristicMetadataUnitsPartsPerMillion API_AVAILABLE(macos(10.10), ios(10.0), watchos(3.0), tvos(10.0))  ;

/*!
 * @brief Describes that the unit of the characteristic is micrograms per cubic meter.
 */
HM_EXTERN NSString * const HMCharacteristicMetadataUnitsMicrogramsPerCubicMeter API_AVAILABLE(macos(10.10), ios(10.0), watchos(3.0), tvos(10.0))  ;
