 ...
 */
@property(readonly, copy, nonatomic) NSString *localizedDescription API_AVAILABLE(macos(10.10), ios(9.0));
 ...
 */
@property(readonly, getter=isUserInteractive, nonatomic) BOOL userInteractive API_AVAILABLE(macos(10.10), ios(9.0));
 ...
 */
@property(readonly, getter=isPrimaryService, nonatomic) BOOL primaryService API_AVAILABLE(macos(10.10), ios(10.0), watchos(3.0), tvos(10.0));
 ...
 */
@property(readonly, copy, nonatomic) NSArray<HMService *> * __nullable linkedServices API_AVAILABLE(macos(10.10), ios(10.0), watchos(3.0), tvos(10.0));
