...
} API_AVAILABLE(macos(10.10), ios(11.0))  ;
 ...
 */
@property(readonly, nonatomic) HMHomeHubState homeHubState API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 *                   will be nil on success.
 */
- (void)addAndSetupAccessoriesWithCompletionHandler:(void (^)(NSError * __nullable error))completion API_AVAILABLE(macos(10.10), ios(10.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 *                   will be nil on success.
 */
- (void)addAndSetupAccessoriesWithPayload:(HMAccessorySetupPayload *)payload completionHandler:(void (^)(NSArray<HMAccessory *>* __nullable accessories, NSError * __nullable error))completion API_AVAILABLE(macos(10.10), ios(11.3)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property(readonly, strong, nonatomic) HMUser *currentUser API_AVAILABLE(macos(10.10), ios(9.0));
 ...
 */
- (void)manageUsersWithCompletionHandler:(void (^)(NSError * __nullable error))completion API_AVAILABLE(macos(10.10), ios(9.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
- (void)addUserWithCompletionHandler:(void (^)(HMUser * __nullable user, NSError * __nullable error))completion API_DEPRECATED_WITH_REPLACEMENT("-manageUsersWithCompletionHandler:", ios(8.0, 9.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
- (void)removeUser:(HMUser *)user completionHandler:(void (^)(NSError * __nullable error))completion API_DEPRECATED_WITH_REPLACEMENT("-manageUsersWithCompletionHandler:", ios(8.0, 9.0)) API_UNAVAILABLE(watchos, tvos);

/*!
 * @brief Retrieve the access level of the user associated with the home.
 */
- (HMHomeAccessControl *)homeAccessControlForUser:(HMUser *)user API_AVAILABLE(macos(10.10), ios(9.0));
 ...
 */
- (nullable HMActionSet *)builtinActionSetOfType:(NSString *)actionSetType API_AVAILABLE(macos(10.10), ios(9.0));
 ...
 */
- (void)homeDidUpdateAccessControlForCurrentUser:(HMHome *)home API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 */
- (void)home:(HMHome *)home didUpdateHomeHubState:(HMHomeHubState)homeHubState API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 */
HM_EXTERN NSString * const HMUserFailedAccessoriesKey API_AVAILABLE(macos(10.10), ios(8.0), watchos(2.0), tvos(10.0))  ;
