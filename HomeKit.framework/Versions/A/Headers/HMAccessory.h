 ...
 *                    its 'uniqueIdentifiersForBridgedAccessories' property set to nil.
 */
@property(readonly, copy, nonatomic, nullable) NSArray<NSUUID *> *uniqueIdentifiersForBridgedAccessories API_AVAILABLE(macos(10.10), ios(9.0));

/*!
 * @brief Category information for the accessory. 
 */
@property(readonly, strong, nonatomic) HMAccessoryCategory *category API_AVAILABLE(macos(10.10), ios(9.0));
 ...
 */
@property(readonly, copy) NSArray<HMAccessoryProfile *> *profiles API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 */
@property (nullable, readonly, copy, nonatomic) NSString *model API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));

/*!
 *  @abstract   Manufacturer of the accessory.
 */
@property (nullable, readonly, copy, nonatomic) NSString *manufacturer API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));

/*!
 *  @abstract   Accessory's firmware version.
 */
@property (nullable, readonly, copy, nonatomic) NSString *firmwareVersion API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));

/*!
 *  @abstract   Indicates if the accessory supports the identify action.
 */
@property (readonly) BOOL supportsIdentify API_AVAILABLE(macos(10.10), ios(11.3), watchos(4.3), tvos(11.3));
 ...
 */
- (void)accessory:(HMAccessory *)accessory didAddProfile:(HMAccessoryProfile *)profile API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 */
- (void)accessory:(HMAccessory *)accessory didRemoveProfile:(HMAccessoryProfile *)profile API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 */
- (void)accessory:(HMAccessory *)accessory didUpdateFirmwareVersion:(NSString *)firmwareVersion API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
