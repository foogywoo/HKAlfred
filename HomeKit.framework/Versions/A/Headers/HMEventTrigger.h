 ...
 */
HM_EXTERN NSString * const HMCharacteristicKeyPath API_AVAILABLE(macos(10.10), ios(9.0), watchos(2.0), tvos(10.0))  ;

/*!
 * @brief Specifies the key path for a characteristic value in a NSPredicate
 */
HM_EXTERN NSString * const HMCharacteristicValueKeyPath API_AVAILABLE(macos(10.10), ios(9.0), watchos(2.0), tvos(10.0))  ;

/*!
 * @brief Specifies the key path for a presence event in a NSPredicate
 */
HM_EXTERN NSString * const HMPresenceKeyPath API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0))  ;
...
- (instancetype)initWithName:(NSString *)name
                 ...
                 recurrences:(nullable NSArray<NSDateComponents *> *)recurrences
                   predicate:(nullable NSPredicate *)predicate API_AVAILABLE(macos(10.10), ios(11.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 */
@property(readonly, copy, nonatomic) NSArray<HMEvent *> *endEvents API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 */
@property(readonly, copy, nonatomic, nullable) NSArray<NSDateComponents *> *recurrences API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));

/*!
 * @brief Specifies whether this trigger is executed only once after which the trigger is disabled.
 */
@property(readonly, nonatomic) BOOL executeOnce API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));

/*!
 * @brief Specifies the current activation state of the trigger.
 */
@property(readonly, assign, nonatomic) HMEventTriggerActivationState triggerActivationState API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 *                   will be nil on success.
 */
- (void)updateEvents:(NSArray<HMEvent *> *)events completionHandler:(void (^)(NSError * __nullable error))completion API_AVAILABLE(macos(10.10), ios(11.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 *                   will be nil on success.
 */
- (void)updateEndEvents:(NSArray<HMEvent *> *)endEvents completionHandler:(void (^)(NSError * __nullable error))completion API_AVAILABLE(macos(10.10), ios(11.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 *                   error will be nil on success.
 */
- (void)updateRecurrences:(nullable NSArray<NSDateComponents *> *)recurrences completionHandler:(void (^)(NSError * __nullable error))completion API_AVAILABLE(macos(10.10), ios(11.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 *                   will be nil on success.
 */
- (void)updateExecuteOnce:(BOOL)executeOnce completionHandler:(void (^)(NSError * __nullable error))completion API_AVAILABLE(macos(10.10), ios(11.0)) API_UNAVAILABLE(watchos, tvos);
 ...
 * @return Predicate object representing a condition to evaluate before executing the action set.
 */
+ (NSPredicate *)predicateForEvaluatingTriggerOccurringBeforeSignificantEvent:(HMSignificantTimeEvent *)significantEvent API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 * @return Predicate object representing a condition to evaluate before executing the action set.
 */
+ (NSPredicate *)predicateForEvaluatingTriggerOccurringAfterSignificantEvent:(HMSignificantTimeEvent *)significantEvent API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
...
+ (NSPredicate *)predicateForEvaluatingTriggerOccurringBetweenSignificantEvent:(HMSignificantTimeEvent *)firstSignificantEvent
                                                        secondSignificantEvent:(HMSignificantTimeEvent *)secondSignificantEvent API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
...
+ (NSPredicate *)predicateForEvaluatingTriggerOccurringBetweenDateWithComponents:(NSDateComponents *)firstDateComponents
                                                        secondDateWithComponents:(NSDateComponents *)secondDateWithComponents API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
 ...
 * @return Predicate object representing a condition to evaluate before executing the action set.
 */
+ (NSPredicate *)predicateForEvaluatingTriggerWithPresence:(HMPresenceEvent *)presenceEvent API_AVAILABLE(macos(10.10), ios(11.0), watchos(4.0), tvos(11.0));
