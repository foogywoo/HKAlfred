...
typedef NS_ENUM(NSInteger, HMCharacteristicValueChargingState) {
    ...
    HMCharacteristicValueChargingStateNotChargeable  API_AVAILABLE(macos(10.10), ios(10.2), watchos(3.1.1), tvos(10.1)),  
} API_AVAILABLE(macos(10.10), ios(10.0), watchos(3.0), tvos(10.0))  ;
...
} API_AVAILABLE(macos(10.10), ios(10.2), watchos(3.1.1), tvos(10.1))  ;
...
} API_AVAILABLE(macos(10.10), ios(10.3), watchos(3.2), tvos(10.2))  ;
